        ...
        actions: [
          GetBuilder<ProductController>(builder: (productController) {
            return Badges(
              ...
              isShow: productController.totalItems > 0,
              tap: () {
                Get.to(CartPage());
              },
            );
                                ...
                                child: Obx(() {
                                  return ShoeCard(
                                    ...
                                    add: () {
                                      ...
                                      // Get.snackbar(
                                      //   "Cart Updated",
                                      //   "Added ${product.name} (Qty: ${productController.cart.firstWhere((p) => p.name == product.name, orElse: () => Product(id: 0, name: '', category: '', price: 0.0, qty: 0, imagePath: '')).qty},)",
